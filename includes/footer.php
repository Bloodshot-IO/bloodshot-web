<footer class="py-8 bg-black text-center text-gray-600 text-sm border-t border-white/5">
        <div class="flex justify-center gap-6 mb-4">
            <a href="https://www.instagram.com/bloodshot_mty/" target="_blank" class="hover:text-white transition-colors">Instagram</a>
            <a href="https://www.linkedin.com/company/bloodshot-io/" class="hover:text-white transition-colors" target="_blank" >LinkedIn</a>
            <a href="https://www.facebook.com/profile.php?id=100091305507034" target="_blank" class="hover:text-white transition-colors">Facebook</a>
        </div>
